...
final class Events
{
     ...
     */
    public const string INFORMATION_COLLECTED = 'netgen_information_collection.events.information_collected';

    /**
     * The BEFORE_ACTION_EXECUTION event occurs before the action execution.
     */
    public const string BEFORE_ACTION_EXECUTION = 'netgen_information_collection.events.before_action_execution';

    /**
     * The ACTION_EXECUTION event occurs after the action execution.
     */
    public const string AFTER_ACTION_EXECUTION = 'netgen_information_collection.events.action_execution';

    /**
     * The ACTION_EXECUTION_FAIL event occurs when the action fails.
     */
    public const string ACTION_EXECUTION_FAIL = 'netgen_information_collection.events.action_execution_fail';

    /**
     * The CRUCIAL_ACTION_EXECUTION_FAIL event occurs when the action marked as crucial fails.
     */
    public const string CRUCIAL_ACTION_EXECUTION_FAIL = 'netgen_information_collection.events.crucial_action_execution_fail';
     ...
     */
    public const string BEFORE_EMAIL_ACTION = 'netgen_information_collection.events.before_email_action';
     ...
     */
    public const string BEFORE_AUTO_RESPONDER_ACTION = 'netgen_information_collection.events.before_auto_responder_action';
}
